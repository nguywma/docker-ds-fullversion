...
REDIS_CONFIG_FILE = "redis_config.txt"
MSGCONV_CONFIG_FILE = "message_convert_config.txt"

FRAMES_DIR = "/home/ivsr/frames"

REDIS_LIB_FILE = "/opt/nvidia/deepstream/deepstream/lib/libnvds_redis_proto.so"
...
def main(args):
    ...
    msgbroker.set_property('config', REDIS_CONFIG_FILE)
    msgbroker.set_property('proto-lib', REDIS_LIB_FILE)
